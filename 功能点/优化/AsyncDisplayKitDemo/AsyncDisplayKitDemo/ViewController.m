...
- (void)viewDidLoad {
    ...
    UIButton *asdkBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [asdkBtn setTitle:@"ASTableNode" forState:UIControlStateNormal];
    [asdkBtn setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    [asdkBtn addTarget:self action:@selector(astableNodeClick) forControlEvents:UIControlEventTouchUpInside];
    asdkBtn.frame = CGRectMake(100, 200, 180, 40);
    [self.view addSubview:asdkBtn];
    
    UIButton *normalBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [normalBtn setTitle:@"NormalTableView" forState:UIControlStateNormal];
    ...
    normalBtn.frame = CGRectMake(100, 300, 180, 40);
    [self.view addSubview:normalBtn];
}
- (void)astableNodeClick
{
    ASDKTableViewController *asdkVC = [[ASDKTableViewController alloc]init];
    asdkVC.dataArray = self.dataArray;
    [self.navigationController pushViewController:asdkVC animated:YES];
}
- (void)normalBtnClick
{
    NormalTableViewController *normalVC = [[NormalTableViewController alloc]init];
    normalVC.dataArray = self.dataArray;
